...
router.get('/usersProducts/getProductsBelowPrice/:price',usersProductsCtrl.getProductsBelowPrice);
router.get('/usersProducts/getProductsByUsername/:username',usersProductsCtrl.getProductsByUsername);
router.get('/usersProducts/getProductsByComponent/:componentNo',usersProductsCtrl.getProductsByComponent);
